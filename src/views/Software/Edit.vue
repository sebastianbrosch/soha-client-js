			...
			<v-form>
				<v-container>
					<v-row>
						...
						<v-col cols="12" md="4">
							<v-text-field v-model="software.licenseKey" label="License Key" required></v-text-field>
						</v-col>
						<v-col cols="12" md="4">
							<v-text-field v-model="software.licenseAmount" label="License Amount" required></v-text-field>
						</v-col>
					</v-row>
					<v-row>
						<v-col cols="12" md="4">
						...
						<v-col cols="12" md="4">
							<v-text-field v-model="software.expiresAt" label="Expires At"></v-text-field>
						</v-col>
						<v-col cols="12" md="4">
							<v-select :items="state" v-model="software.state" label="State" required></v-select>
						</v-col>
					</v-row>
					<v-row>
						<v-col cols="12" md="12">
